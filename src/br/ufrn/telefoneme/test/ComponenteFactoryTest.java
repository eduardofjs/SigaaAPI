...
public class ComponenteFactoryTest {
	...
	public void test() {		
		...
		} catch (JsonStringInvalidaException | CargaHorariaDesconhecidaException | IdException | ConexaoException e) {
			e.printStackTrace();
		}
		
	}
	private void verificaComponente(Componente compGerado, ComponenteCurricularDTO componente) throws JsonStringInvalidaException, ConexaoException, IdException{
